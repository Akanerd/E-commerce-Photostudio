...
<head>
    ...
    <!-- Meta-Information -->
    <title>PhotoStudio | Halaman Administrator </title>
    <meta charset="utf-8">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-md-4 col-md-offset-4">
                <a href="../logout.php" class="c-btn large blue-bg">Ya</a>
...
?>
        ...
        <script type="text/javascript" class="init">
            ...
            $(document).on( "click", '.edit_button',function(e) {
                ...
                $("#"+merk).attr({"selected": true});
                $(".edit_id").val(id);
                $(".edit_nama").val(nama);
                $(".edit_garansi").val(garansi);
            ...
            $(document).on( "click", '.delete_button',function(e) {
                ...
                $(".hapus_id").val(id);
                $(".hapus_nama").val(nama);
                $(".hapus_garansi").val(garansi);
                $(".hapus_berat").val(berat);
            });
        </script>
