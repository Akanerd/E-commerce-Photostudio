<?php
    ...
    $komentar=mysqli_query($konek, "SELECT komen.*, produk.nama_produk FROM tb_komentar komen INNER JOIN tb_produk produk ON komen.id_produk=produk.id_produk WHERE komen.hapus=0 ORDER BY komen.id_komentar DESC");
    $deleted=mysqli_query($konek, "SELECT komen.*, produk.nama_produk FROM tb_komentar komen INNER JOIN tb_produk produk ON komen.id_produk=produk.id_produk WHERE komen.hapus=1 ORDER BY komen.id_komentar DESC");
?>
                                        ...
                                        ?>
                                         <tr>
                                            ...
                                            <td>
                                                ...
                                                data-komentar='<?php echo $strip; ?>' data-judul='<?php echo $row['nama_produk']; ?>' class="c-btn small red-bg buzz delete_button"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                         <?php $no++; } ?>
                                     </tbody>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            <label for="judul">Pada Produk</label>
